            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    EnableOrdering = table.Column<bool>(type: "tinyint(1)", nullable: false, defaultValue: true, comment: "點餐系統啟用"),
                    EnableDineIn = table.Column<bool>(type: "tinyint(1)", nullable: false, defaultValue: true, comment: "啟用內用"),
                    EnableTakeout = table.Column<bool>(type: "tinyint(1)", nullable: false, defaultValue: true, comment: "啟用外帶"),
                    EnableDelivery = table.Column<bool>(type: "tinyint(1)", nullable: false, defaultValue: true, comment: "啟用外送")
                },
                constraints: table =>
                {
